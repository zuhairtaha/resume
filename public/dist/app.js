...
},{"ev-emitter":"../node_modules/ev-emitter/ev-emitter.js"}],"javascripts/mansory_grid.js":[function(require,module,exports) {
"use strict";
...
function fetchSamples() {
  ...
  fetch("./javascripts/samples.json").then(function (data) {
    ...
    var samplesList = '<div class="grid-sizer"></div>';
    webObjects.forEach(function (web) {
      ...
      samplesList += "\n                <div class=\"".concat(divClass, "\">\n                    <a class=\"hvr-grow-shadow\" href=\"images/websites/").concat(web.id, ".jpg\"> \n                        <img class=\"responsive-img z-depth-2\" src=\"images/thumb/thumb_").concat(web.id, ".jpg\">\n                    </a>\n                </div>");
    });
...
},{"masonry-layout":"../node_modules/masonry-layout/masonry.js","imagesloaded":"../node_modules/imagesloaded/imagesloaded.js"}],"javascripts/skills.js":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "17676" + '/');
